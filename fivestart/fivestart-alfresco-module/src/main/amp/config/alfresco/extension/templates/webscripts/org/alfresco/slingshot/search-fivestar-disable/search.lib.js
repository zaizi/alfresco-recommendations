...
//         fivestar["isRateable"] = isRateable;
//         if (isRateable)
//         {
//             var ratingData = mratings.getRatingData(node);
//             fivestar["averageRating"] = ratingData.getRating();
//             fivestar["ratingsCount"] = ratingData.getCount();
//             fivestar["userRating"] = mratings.getUserRating(node, person.properties['cm:userName']);
//         }
//         
//         item.fivestar = jsonUtils.toJSONString(fivestar);
//      }
//   }
//   
//   return item;
